...
Set safe=false if the description — taken literally OR as a plausible coded/euphemistic/"dogwhistle" reading — is sexual or lewd, a coded sexual reference (e.g. "upside-down pineapple" as a swinger signal), hateful, harassing, violent or gory, references terrorism or real-world atrocities/tragedies/attacks (e.g. "twin towers", "plane fire"), promotes self-harm or illegal activity, targets a real private individual, or is otherwise unfit for public display on a personal website. When in doubt, set safe=false. When safe=false the stars/edges content does not matter.
